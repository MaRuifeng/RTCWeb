...
/**
 * Parent class for JPA services for the results handler 
 * @author ruifengm
 * @since 2015-Dec-07
 */
public abstract class AppTestJPAService {
	private static final String className = AppTestJPAService.class.getName();
	 ...
	 */ 
	@PersistenceContext(unitName="GPOTestJPA")
